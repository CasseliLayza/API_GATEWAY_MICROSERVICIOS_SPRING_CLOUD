    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.authorizeHttpRequests(authz -> {
                    authz.requestMatchers("/authorized", "logout").permitAll()
                            .requestMatchers(HttpMethod.GET, "/api/a/products/list", "/api/b/items/list", "/api/c/users/list").permitAll()
                            .requestMatchers(HttpMethod.GET, "/api/a/products/find/{id}", "/api/b/items/find/{id}", "/api/c/users/find/{id}").hasAnyRole("USER", "ADMIN")
                            .requestMatchers("/api/a/products/**", "/api/b/items/**", "/api/c/users/**").hasRole("ADMIN")
                            /*.requestMatchers(HttpMethod.POST, "/api/a/products/create", "/api/b/items/create", "/api/c/users/create").hasRole("ADMIN")
                            .requestMatchers(HttpMethod.PUT, "/api/a/products/update/{id}", "/api/b/items/update/{id}", "/api/c/users/update/{id}").hasRole("ADMIN")
                            .requestMatchers(HttpMethod.DELETE, "/api/a/products/delete/{id}", "/api/b/items/delete/{id}", "/api/c/users/delete/{id}").hasRole("ADMIN")*/
...
/*.pathMatchers(HttpMethod.POST, "/api/a/products/create", "/api/b/items/create", "/api/c/users/create").hasRole("ADMIN")
                ...
                .securityContextRepository(NoOpServerSecurityContextRepository.getInstance()) // No guardar
